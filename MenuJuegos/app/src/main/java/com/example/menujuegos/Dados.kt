...
import com.example.menujuegos.databinding.DadosBinding
import kotlin.random.Random

lateinit var binding: DadosBinding;
...
class Dados : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding=DadosBinding.inflate(layoutInflater)
        setContentView(binding.root)

        binding.txTitulo.setText(intent.getStringExtra("nombre"))
