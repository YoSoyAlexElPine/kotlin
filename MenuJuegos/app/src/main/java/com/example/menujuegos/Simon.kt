...
import com.example.menujuegos.databinding.SimonBinding

class Simon : AppCompatActivity() {

    val r = Random.Default

    override fun onCreate(savedInstanceState: Bundle?) {

        var b = SimonBinding.inflate(layoutInflater)
        ...
        b.textView.setText(intent.getStringExtra("nombre"))
    ...
    fun deshabilitarBotones(b: SimonBinding) {
    ...
    fun mostrarSecuencia(secuencia: LinkedList<Int>, b: SimonBinding) {
